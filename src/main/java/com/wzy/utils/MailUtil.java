...
/**
 * Reference:http://blog.csdn.net/qq_28663043/article/details/70153890
 */
public class MailUtil {

    private static final String HOST = "smtp.qq.com";
    private static final String SMTP = "smtp";
    private static final String USERNAME = "2168191488@qq.com";
    private static final String PASSWORD = "xvdpggfuxxiyecej";
...
//      String[] array = new String[] {"88888@qq.com","666666@qq.com","999999999@qq.com",USERNAME};
        String[] array = new String[] {USERNAME,"chriswangzheyi@hotmail.com"};
        String subject = "Cherish内嵌图片、音乐的邮件";


        String filePath = "D:/javamail.jpg";
